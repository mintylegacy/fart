...
LPH_JIT_MAX(function() -- Main Cheat
    ...
    local pathfinding = loadstring(game:HttpGet("https://raw.githubusercontent.com/mintylegacy/fart/refs/heads/main/pathfinder.lua"))() -- i didnt make this, i did fix it tho cuz pro
